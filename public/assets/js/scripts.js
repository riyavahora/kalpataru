...
//        controlNav: "thumbnails",
    ...
    /*
     Google maps
     */
//	var position = new google.maps.LatLng(22.396428, 114.109497);
...
//    });
    ...
    $('.footer-box-text-subscribe form').submit(function (e) {
        e.preventDefault();
        $('#subscribtion-form').find('#subscribe-email').removeClass('errorinput');
        var form = $(this);
        ...
        $.ajax({
            ...
            success: function (json) {
                if (json.valid == 0) {
                    ...
                    $('#subscribtion-form').find('#subscribe-email').val('');
                    $('#subscribtion-form').find('#subscribe-email').addClass('errorinput');
                } else {
                    $('.error-message').hide();
                    $('.success-message').hide();
                    form.hide();
...
//        $.ajax({
//            type: 'POST',
//            url: 'send_mail_to_subscribers.php',
//            data: postdata,
//            dataType: 'json',
//            success: function (json) {
//                if (json == 'success') {
//                    $('.error-message').hide();
//                    $('.success-message').hide();
//                    $('.success-message').html('Your mail has been sent to subscribers.');
//                    $('.success-message').fadeIn();
//                } else {
//                    $('.success-message').hide();
//                    $('.error-message').hide();
//                    $('.error-message').html('Oops ! Error in sending mail.Please try again later.');
//                    $('.error-message').fadeIn();
//                }
//            }
//        });
